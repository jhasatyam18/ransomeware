...
export const FIELDS = {
  ...
  'node.replicationCtrlPort': {
    label: 'node.replicationCtrlPort', defaultValue: 5000, min: 1, max: 65536, type: FIELD_TYPE.NUMBER, errorMessage: 'Port value required', shouldShow: (user) => shouldShowNodeReplicationPort(user), fieldInfo: 'info.node.replicationCtrlPort',
  },
  'node.replicationDataPort': {
    label: 'node.replicationDataPort', defaultValue: 5001, min: 1, max: 65536, type: FIELD_TYPE.NUMBER, errorMessage: 'Port value required', shouldShow: (user) => shouldShowNodeReplicationDataPort(user), fieldInfo: 'info.node.replicationDataPort',
  },
  ...
  'stop.repl.reason': { label: 'Reason', placeHolderText: 'Reason', type: FIELD_TYPE.TEXT, maxLength: 128, shouldShow: true, fieldInfo: 'Please provide reason', validate: (value, user) => isEmpty(value, user), errorMessage: 'pleas', errorFunction: errorMessageForReasonInReplOp },
};
