...
export const MODAL_SHOW_WINPREP_UPDATE_WARNING = 'MODAL_SHOW_WINPREP_UPDATE_WARNING';
export const MODAL_GENERATE_REPORT_SCHEDULE = 'MODAL_GENERATE_REPORT_SCHEDULE';
export const MODAL_CHANGE_SCHEDULE_STATUS = 'MODAL_CHANGE_SCHEDULE_STATUS';
export const MODAL_SET_TAGER_STORAGE = 'MODAL_SET_TAGER_STORAGE';
