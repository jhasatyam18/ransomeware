...
function StatusItemRenderer({ data, field, t, noPopOver, showDate, user, dispatch, options }) {
  ...
  const errorStatus = [JOB_FAILED, JOB_STOPPED, JOB_INIT_FAILED, JOB_SYNC_FAILED, NODE_STATUS_OFFLINE, JOB_RESYNC_FAILED, JOB_INIT_SYNC_FAILED, MIGRATION_INIT_FAILED, AUTO_MIGRATION_FAILED, DISABLED, TEST_RECOVERY_FAILED, FULL_RECOVERY_FAILED, MIGRATION_FAILED];
