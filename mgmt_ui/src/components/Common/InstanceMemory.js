...
function Memory(props) {
  ...
  const numField = { label: '', errorMessage: 'required', shouldShow: true, validate: ({ value }) => validateMemoryValue({ value, user, fieldKey }), min: 1, max: 4000, disabled: () => diableVMwareMemory(user, fieldKey), defaultValue: 2 };
