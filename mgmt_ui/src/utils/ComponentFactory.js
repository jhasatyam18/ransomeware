...
import AwsTargetStorageRenderer from '../components/Table/ItemRenderers/AwsTargetStorageRenderer';
import NodeHostnameItemRender from '../components/Table/ItemRenderers/NodeHostnameItemRenderer';
...
import PlanListWorkloadRendereroadRenderer from '../components/Table/ItemRenderers/PlanListWorkloadRenderer';
...
export function getItemRendererComponent({ render, data, field, user, dispatch, options }) {
  switch (render) {
    ...
    case PLAN_LIST_WORKLOAD:
      return <PlanListWorkloadRendereroadRenderer data={data} />;
    case VM_REPL_STATUS:
    ...
    case NODE_HOSTNAME_ITEM_RENDERER:
      return <NodeHostnameItemRender data={data} user={user} />;
    case AWS_TARGET_STORAGE_OPTION_RENDERER:
      return <AwsTargetStorageRenderer data={data} user={user} options={options} dispatch={dispatch} />;
    default:
  }
}
