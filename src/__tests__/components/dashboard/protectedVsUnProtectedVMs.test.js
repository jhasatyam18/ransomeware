...
const replicationJobResp = { protectedVMs: 1, unprotectedVMs: 19 };
const recoveredJobResp = { changedRate: 3.1607142857142856, completed: 8, dataReduction: 59.31, failed: 2, inSync: 1, notInsync: 0, rpo: 600, running: 0 };
const jobReplicationResp = withoutErrorResponse(API_DASHBOARD_VIRTUAL_MACHINE_PROTECTION_ANALYSIS_PROTECTED_VMS, replicationJobResp);
const jobRecoveryResp = withoutErrorResponse(API_DASHBOARD_REPLICATION_STATS, recoveredJobResp);
const handlers = [jobRecoveryResp, jobReplicationResp];
