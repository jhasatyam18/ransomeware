...
export const DRPLAN_PROTECTION_CONFIG_STEP_FIELDS = ['drplan.subnet', 'replication.inerval', 'drplan.isEncryptionOnWire', 'drplan.isEncryptionOnRest', 'drplan.isCompression', 'drplan.isDedupe'];
