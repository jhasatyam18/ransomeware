...
export const PROTECTION_PLANS = '/protection/*';
...
export const PROTECTION_PLAN_STOP_REPLICATION = '/protection/plan/details/:id/*';
export const PROTECTION_PLAN_FLOW = '/protection/plan/details/:id/:flow';
...
export const REPORT_SCHEDULE_CREATE = '/Reports/reportSchedule/*';
