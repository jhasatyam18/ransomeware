...
export const FIELDS = {
  ...
  'drplan.memory.unit': { label: 'Unit', onChange: (user, dispatch) => getMemoryValue(user, dispatch), errorMessage: '', options: [{ label: 'GB', value: 'GB' }, { label: 'MB', value: 'MB' }, { label: 'TB', value: 'TB' }], shouldShow: true, validate: (value, user) => isEmpty(value, user), min: 1 },
};
