...
export const FIELDS = {
  ...
  'recovery.removeFromAD': { label: 'recovery.removeFromAD', description: 'Remove From Windows AD', placeHolderText: '', type: FIELD_TYPE.CHECKBOX, validate: null, errorMessage: '', shouldShow: true, defaultValue: true, fieldInfo: 'info.recovery.remove.windows.ad' },
