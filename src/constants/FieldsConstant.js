...
export const FIELDS = {
  ...
  'recovery.installSystemAgent': { label: 'recovery.installSystemAgent', description: 'Install System Agents', placeHolderText: '', type: FIELD_TYPE.CHECKBOX, validate: null, errorMessage: '', defaultValue: false, fieldInfo: 'info.recovery.system.agent' },
