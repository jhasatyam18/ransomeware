...
export const FIELDS = {
  ...
  'drplan.preScript': { label: 'Pre Script', placeHolderText: 'Pre Script to execute before Recovery', type: FIELD_TYPE.SELECT, options: (user) => getPreScriptsOptions(user), errorMessage: 'Select recovery pre script', shouldShow: true, onChange: (user, dispatch) => onScriptChange(user, dispatch) },
  'drplan.postScript': { label: 'Post Script', placeHolderText: 'Post Script to execute post Recovery', type: FIELD_TYPE.SELECT, options: (user) => getPostScriptsOptions(user), errorMessage: 'Select recovery post script', shouldShow: true, onChange: (user, dispatch) => onScriptChange(user, dispatch) },
  'drplan.preInputs': { label: 'Pre Script Inputs', type: FIELD_TYPE.TEXT, placeHolderText: 'input params', shouldShow: true },
  'drplan.postInputs': { label: 'Post Script Inputs', type: FIELD_TYPE.TEXT, placeHolderText: 'input params', shouldShow: true },
