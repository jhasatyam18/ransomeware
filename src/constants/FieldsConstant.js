...
export const FIELDS = {
  ...
  'drplan.memory.value': { label: 'CPU', errorMessage: '', shouldShow: true, validate: ({ value, user, fieldKey }) => isEmpty({ value, user, fieldKey }), min: 1, max: 4000, disabled: (user, fieldKey) => diableVMwareMemory(user, fieldKey) },
