...
export const FIELDS = {
  ...
  'drplan.enablePPlanLevelScheduling': { label: 'Enable VM Level Replication Scheduling', description: 'Enable For Reverse', type: FIELD_TYPE.CHECKBOX, shouldShow: true, defaultValue: false, fieldInfo: 'info.protectionplan.enable.replication.scheduling' },
