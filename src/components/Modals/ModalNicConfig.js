...
class ModalNicConfig extends Component {
  ...
  renderAzureConfig() {
    ...
    const publicIP = { fieldInfo: 'info.protectionplan.network.azure.externalip', label: 'Public IP', placeHolderText: 'Assign New', description: '', type: FIELD_TYPE.SELECT, shouldShow: true, errorMessage: 'Select Public IP', options: (u) => getAzureExternalIPOptions(u), validate: (v, u) => isEmpty(v, u) };
