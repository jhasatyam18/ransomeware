...
import { PPLAN_EVENTS, VM_CONFIG_ACTION_EVENT, VM_DISK_ACTION_EVENT } from '../../constants/EventConstant';
...
class ModalAlertDetails extends Component {
  ...
  renderTakeAction() {
    ...
    if (VM_DISK_ACTION_EVENT.indexOf(type) !== -1 || VM_CONFIG_ACTION_EVENT.indexOf(type) !== -1 || PPLAN_EVENTS.indexOf(type) !== -1) {
