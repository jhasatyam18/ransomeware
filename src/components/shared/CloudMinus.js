...
function CloudMinusButton(props) {
  const { size } = props;
  return (
    <svg width={`${size}em`} height={`${size}em`} viewBox="0 0 16 16" className="bi bi-cloud-plus" fill="currentColor">
...
export default CloudMinusButton;
