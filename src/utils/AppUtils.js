...
export function getSideBarContents() {
  const menu = [
    ...
    { label: 'monitor',
      ...
      hasSubMenu: true,
      subMenu: [
        { label: 'events', to: RPATH.EVENTS_PATH, icon: faCalendar, isActivePath: [RPATH.EVENTS_PATH], hasChildren: false },
        { label: 'alerts', to: RPATH.ALERTS_PATH, icon: faClockFour, isActivePath: [RPATH.ALERTS_PATH], hasChildren: false },
        { label: 'report', to: RPATH.REPORTS_PATH, icon: faFileContract, isActivePath: [RPATH.REPORTS_PATH], hasChildren: false },
      ],
    },
    { label: 'settings',
      to: '#',
      ...
      hasSubMenu: true,
      subMenu: [
        { label: 'license', to: RPATH.LICENSE_SETTINGS_PATH, icon: faIdCard, isActivePath: [RPATH.LICENSE_SETTINGS_PATH], hasChildren: false },
        { label: 'email', to: RPATH.EMAIL_SETTINGS_PATH, icon: faEnvelope, isActivePath: [RPATH.EMAIL_SETTINGS_PATH], hasChildren: false },
        { label: 'scripts', to: RPATH.SCRIPTS_PATH, icon: faScroll, isActivePath: [RPATH.SCRIPTS_PATH], hasChildren: false },
        { label: 'throttling', to: RPATH.THROTTLING_SETTINGS_PATH, icon: faTachometerAltFast, isActivePath: [RPATH.THROTTLING_SETTINGS_PATH], hasChildren: false },
        { label: 'roles', to: RPATH.ROLES_SETTINGS_PATH, icon: faUserShield, isActivePath: [RPATH.ROLES_SETTINGS_PATH], hasChildren: false },
