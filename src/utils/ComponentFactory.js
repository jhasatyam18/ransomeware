...
import ReverseOptionRenderer from '../components/Common/ReverseOptionRenderer';
...
export function getStackComponent(dispatch, user, children, conf, data) {
  ...
  switch (field.type) {
    ...
    case STACK_COMPONENT_RADIO:
      return <ReverseOptionRenderer dispatch={dispatch} fieldKey={conf} field={children[conf]} user={user} hideLabel="true" />;
    default:
