...
import { STACK_COMPONENT_NETWORK, STACK_COMPONENT_LOCATION, STACK_COMPONENT_MEMORY, STACK_COMPONENT_SECURITY_GROUP, STACK_COMPONENT_TAGS, STACK_COMPONENT_NOTE } from '../constants/StackConstants';
...
export function getStackComponent(dispatch, user, children, conf, data) {
  ...
  switch (field.type) {
    ...
    case STACK_COMPONENT_NOTE:
      return (
        <>
          <p>test recoovery wrkflow</p>
        </>
      );
