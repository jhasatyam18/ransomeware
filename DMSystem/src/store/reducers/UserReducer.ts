...
export default function user(state = INITIAL_STATE.user, action: UserInterface) {
    switch (action.type) {
        case Types.APP_REFRESH:
            return {
                ...state,
                context: { ...state.context, refresh: state.context.refresh + 1 },
            };
        ...
        case Types.APP_USER_CHANGE_PASSWORD:
            return {
                ...state,
                passwordChangeReq: action.passwordChangeReq,
                isAuthenticated: false,
        ...
        case Types.APP_USER_RESET_PASSWORD:
            return {
                ...state,
                passwordResetReq: action.passwordResetReq,
                allowReset: action.allowReset,
            };
        ...
        case Types.SET_UPGRADE_SUMMARY_ACTIVE_TAB: {
            return { ...state, upgradeSummaryTab: action.value };
        }
        default:
            return state;
    }
