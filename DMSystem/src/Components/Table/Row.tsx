...
// Define a functional component that receives a checkbox change handler as prop
...
class DMTableRow extends Component<Props> {
    ...
    getItemRenderer(itemRenderer: string, data: any, field: string) {
        const { user, dispatch } = this.props;
        return getItemRendererComponent({ itemRenderer, data, field, user, dispatch });
    }
